...
const materialProjectFormSchema = z.object({
  ...
  quantity: z.number().min(0, "La cantidad debe ser no negativa").default(0),
  ...
  purchasedValue: z.number().min(0, "El valor de compra debe ser no negativo").default(0),
...
export const MaterialProjectForm: React.FC<MaterialProjectFormProps> = ({
  ...
  const form = useForm<MaterialProjectFormData>({
    ...
    defaultValues: {
      ...
      purchasedValue: existingMaterial?.purchasedValue ?? 0,
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <FormField
                    ...
                    <FormItem>
                        ...
                        <FormDescription>Costo total de adquisición del material.</FormDescription>
                        <FormMessage />
                    </FormItem>
                    )}
                />
